...
import com.example.yourstorymyapp.databinding.ActivityOpenCameraBinding
import com.example.yourstorymyapp.presentation.utils.createFile
...
class OpenCameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.takeImage.setOnClickListener { takePhoto() }
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onError(exc: ImageCaptureException) {
                    Toast.makeText(
                        ...
                        getString(R.string.picture_take_failed),
                        Toast.LENGTH_SHORT
                    ).show()
                }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Toast.makeText(
                    this@OpenCameraActivity,
                    getString(R.string.fail_open_camera),
                    Toast.LENGTH_SHORT
                ).show()
            }
        }, ContextCompat.getMainExecutor(this))
